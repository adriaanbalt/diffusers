...
# SolarVision requires torch.use_deterministic_algorithms(False) due to complex64 RoPE operations.
...
class TestSolarVisionTransformerTraining(SolarVisionTransformerTesterConfig, TrainingTesterMixin):
    def test_gradient_checkpointing_is_applied(self):
        expected_set = {"SolarVisionTransformer2DModel"}
...
class TestSolarVisionTransformerCompile(SolarVisionTransformerTesterConfig, TorchCompileTesterMixin):
    ...
    @pytest.mark.skip(
        reason="The repeated block in this model is SolarVisionSharedAdaLNBlock. As a consequence of this, "
