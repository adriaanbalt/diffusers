...
class SolarVisionCombinedTimestepCaptionEmbedding(nn.Module):
    def __init__(
        self,
...
class SolarVisionAttnProcessor2_0:
    r"""
    Processor for implementing scaled dot-product attention (enabled by default if you're using PyTorch 2.0). This is
    used in the SolarVisionTransformer2DModel model. It applies normalization and RoPE on query and key vectors.
    """
...
class SolarVisionTransformerBlock(nn.Module):
    def __init__(
        self,
        dim: int,
        ...
        self.attn = Attention(
            ...
            bias=False,
            out_bias=False,
            processor=SolarVisionAttnProcessor2_0(),
        )
...
class SolarVisionRotaryPosEmbed(nn.Module):
...
class SolarVisionTransformer2DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    r"""
    SolarVisionNextDiT: Diffusion model with a Transformer backbone.
    ...
    _no_split_modules = ["SolarVisionTransformerBlock"]
    ...
    def __init__(
        ...
        self.rope_embedder = SolarVisionRotaryPosEmbed(
        ...
        self.time_caption_embed = SolarVisionCombinedTimestepCaptionEmbedding(
