...
class SolarVisionLoopBeforeDenoiser(ModularPipelineBlocks):
    ...
    def description(self) -> str:
        return (
            ...
            "object (e.g. `SolarVisionDenoiseLoopWrapper`)."
        )

    @property
    def expected_components(self) -> list[ComponentSpec]:
        return [ComponentSpec("transformer", SolarVisionTransformer2DModel)]
    ...
    @torch.no_grad()
    def __call__(self, components: SolarVisionModularPipeline, block_state: BlockState, i: int, t: torch.Tensor):
...
class SolarVisionLoopDenoiser(ModularPipelineBlocks):
    ...
    def description(self) -> str:
        return (
            "Step within the denoising loop that runs the SolarVision transformer with classifier-free guidance via "
...
class SolarVisionDenoiseStep(SolarVisionDenoiseLoopWrapper):
    block_classes = [
        SolarVisionLoopBeforeDenoiser,
        SolarVisionLoopDenoiser,
        SolarVisionLoopAfterDenoiser,
    ]
