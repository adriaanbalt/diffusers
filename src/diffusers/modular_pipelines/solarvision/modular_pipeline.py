...
class SolarVisionPachifier(ConfigMixin):
    """
    A class to pack and unpack latents for SolarVision.
    """
...
class SolarVisionModularPipeline(ModularPipeline):
    """
    A ModularPipeline for SolarVision.
