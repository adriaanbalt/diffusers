...
class SolarVisionPrepareLatentsStep(ModularPipelineBlocks):
    ...
    @property
    def description(self) -> str:
        return "Prepare random noise latents for the SolarVision text-to-image denoising process."
    ...
    @staticmethod
    def _check_inputs(components: SolarVisionModularPipeline, height: int, width: int) -> None:
