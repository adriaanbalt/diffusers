...
class SolarVisionVaeDecoderStep(ModularPipelineBlocks):
    ...
    def __call__(self, components, state: PipelineState) -> PipelineState:
        ...
        if block_state.output_type == "latent":
            ...
            latents = (block_state.latents / components.vae.config.scaling_factor) + components.vae.config.shift_factor
